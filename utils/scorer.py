...
def score(key, prediction, verbose=False):
    ...
    num_of_no_relation = 0
    num_of_no_relation_correct = 0
    ...
    for row in range(len(key)):
        ...
        if gold == NO_RELATION:
            num_of_no_relation += 1

        if gold == NO_RELATION and guess == NO_RELATION:
            num_of_no_relation_correct +=1
            pass
    ...
    acc_no_relation = num_of_no_relation_correct / num_of_no_relation
    print( "Precision (micro): {:.3%}".format(prec_micro) )
    print( "   Recall (micro): {:.3%}".format(recall_micro) )
    print( "       F1 (micro): {:.3%}".format(f1_micro) )
    print( "acc_no_relation, num_of_no_relation_correct, num_of_no_relation : {:.3%}, {}, {}".format
        (acc_no_relation, num_of_no_relation_correct, num_of_no_relation) )
